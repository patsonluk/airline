...
function showAirplaneModelConfigurationsModal(modelConfigurationInfo) {
    ...
    $.each(modelConfigurationInfo.configurations, function(index, configuration) {
        ...
        var perInputSpan
        perInputSpan = $('<div style="margin-left: 10px; margin-right: 10px; display: inline-block;" class="economy">Economy: <input type="number" class="economyInput" maxlength="3" size="3" onkeyup="onManualInputUpdate($(this).closest(\'.config\'), \'economy\', $(this).val())"></div>')
        ...
        perInputSpan = $('<div style="margin-left: 10px; margin-right: 10px; display: inline-block;" class="business">Business: <input type="number" class="businessInput" maxlength="3" size="3" onkeyup="onManualInputUpdate($(this).closest(\'.config\'), \'business\', $(this).val())"></div>')
        ...
        manualInputDiv.append(perInputSpan)
        perInputSpan = $('<div style="margin-left: 10px; margin-right: 10px; display: inline-block;" class="first">First: <input type="number" class="firstInput" maxlength="3" size="3" onkeyup="onManualInputUpdate($(this).closest(\'.config\'), \'first\', $(this).val())"></div>')
