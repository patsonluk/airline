...
object AirplaneModelInitializer extends App {
  ...
  def populateAirplaneModels() = {
    ...
    val models = List(Model("Cessna 421", capacity = 7, fuelBurn = 6, speed = 300, range = 1555, price = 550000),
                      ...
                      Model("Bombardier CS100", capacity = 133, fuelBurn = 180, speed = 828, range = 5741, price = 71800000),
                      ...
                      Model("Boeing 777-300", capacity = 550, fuelBurn = 500, speed = 945, range = 11121, price = 250000000),
