...
function showAirplaneModelConfigurationsModal(modelConfigurationInfo) {
    ...
    $.each(modelConfigurationInfo.configurations, function(index, configuration) {
        ...
        var perInputSpan
        perInputSpan = $('<span style="margin-left: 10px; margin-right: 10px;" class="economy">Economy: <input type="text" class="economyInput" maxlength="3" size="3" onkeyup="onManualInputUpdate($(this).closest(\'.config\'), \'economy\', $(this).val())"></span>')
        ...
        perInputSpan = $('<span style="margin-left: 10px; margin-right: 10px;" class="business">Business: <input type="text" class="businessInput" maxlength="3" size="3" onkeyup="onManualInputUpdate($(this).closest(\'.config\'), \'business\', $(this).val())"></span>')
        ...
        manualInputDiv.append(perInputSpan)
        perInputSpan = $('<span style="margin-left: 10px; margin-right: 10px;" class="first">First: <input type="text" class="firstInput" maxlength="3" size="3" onkeyup="onManualInputUpdate($(this).closest(\'.config\'), \'first\', $(this).val())"></span>')
