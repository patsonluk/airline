...
object Model {
  ...
  val models = List(Model("Cessna 421", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, countryCode = "US"),
                    Model("Pilatus PC-12", capacity = 9, fuelBurn = (9 * 1.2).toInt, speed = 528, range = 3417, price = 4000000, lifespan = 35 * 52, constructionTime = 0, countryCode = "CH"),
                      ...
                      Model("Embraer E195-E2", capacity = 146, fuelBurn = (146 * 3.7).toInt, speed = 833, range = 4800, price = 60400000, lifespan = 30 * 52, constructionTime = 12, countryCode = "BR", imageUrl = "https://www.norebbo.com/2019/03/embraer-e195-e2-side-view/"),
                      Model("Airbus A319", capacity = 156, fuelBurn = (156 * 3.4).toInt, speed = 830, range = 6940, price = 95000000, lifespan = 35 * 52, constructionTime = 12, countryCode = "NL", imageUrl = "https://www.norebbo.com/2014/05/airbus-a319-blank-illustration-templates/"),
                      ...
                      Model("Tupolev Tu-154", capacity = 180, fuelBurn = (180 * 4.8).toInt, speed = 913, range = 5280, price = 45000000, lifespan = 25 * 52, constructionTime = 24, countryCode = "RU", imageUrl = "https://www.norebbo.com/2019/05/tupolev-tu-154-side-view/"),
                      ...
                      Model("Airbus A321", capacity = 236, fuelBurn = (236 * 4.3).toInt, speed = 830, range = 5930, price = 120000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "NL", imageUrl = "https://www.norebbo.com/2014/03/airbus-a321-blank-illustration-templates/"),
                      ...
                      Model("Airbus A350-900 ULR", capacity = 250, fuelBurn = (250 * 6).toInt, speed = 903, range = 18000, price = 282000000, lifespan = 35 * 52, constructionTime = 48, countryCode = "NL", imageUrl = "https://www.norebbo.com/2013/07/airbus-a350-900-blank-illustration-templates/" ),
                      ...
                      Model("Boeing 747-8I", capacity = 605, fuelBurn = (605 * 5.5).toInt, speed = 945, range = 15000, price = 357000000, lifespan = 35 * 52, constructionTime = 48, countryCode = "US", imageUrl = "https://www.norebbo.com/2015/12/boeing-747-8i-blank-illustration-templates/"),
