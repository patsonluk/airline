...
object Model {
  ...
  val models = List(
    ...
    Model("Airbus A350-1000 Sunrise",	"Airbus A350",	380,	8,	2126,	910,	18000,	513000000,	1820,	120,	Manufacturer("Airbus",	countryCode="NL"),	2700,	imageUrl ="https://www.norebbo.com/2015/11/airbus-a350-1000-blank-illustration-templates/"),
    ...
    Model("Boeing 307 Stratoliner",	"Boeing 307",	60,	1,	256,	357,	3850,	6400000,	1456,	0,	Manufacturer("Boeing",	countryCode="US"),	620,	imageUrl =""),
    Model("Boeing 377 Stratocruiser",	"Boeing 377",	117,	2,	528,	480,	6760,	39000000,	1456,	24,	Manufacturer("Boeing",	countryCode="US"),	1000,	imageUrl =""),
    ...
    Model("Boeing 767-300ER",	"Boeing 767",	290,	5,	1257,	903,	11093,	212000000,	1820,	108,	Manufacturer("Boeing",	countryCode="US"),	2650,	imageUrl ="https://www.norebbo.com/2014/07/boeing-767-200-blank-illustration-templates/"),
    Model("Boeing 767-400ER",	"Boeing 767",	375,	5,	1745,	851,	10415,	233500000,	1820,	108,	Manufacturer("Boeing",	countryCode="US"),	3290,	imageUrl ="https://www.norebbo.com/2014/07/boeing-767-400-blank-illustration-templates/"),
    ...
    Model("Boeing 777-9",	"Boeing 777",	550,	7,	2705,	896,	13940,	550300000,	1820,	132,	Manufacturer("Boeing",	countryCode="US"),	3050,	imageUrl ="https://www.norebbo.com/2019/12/boeing-777-9-side-view/"),
    Model("Boeing 777-8",	"Boeing 777",	440,	6,	1966,	896,	16090,	389500000,	1820,	108,	Manufacturer("Boeing",	countryCode="US"),	3050,	imageUrl ="https://www.norebbo.com/2019/12/boeing-777-8-side-view/"),
    ...
    Model("Boeing 777-300ER",	"Boeing 777",	550,	6,	3115,	896,	13649,	406900000,	1820,	132,	Manufacturer("Boeing",	countryCode="US"),	3050,	imageUrl ="https://www.norebbo.com/2014/03/boeing-777-300-blank-illustration-templates/"),
    ...
    Model("Bombardier Global 7500",	"Bombardier Global",	30,	10,	40,	902,	14260,	31500000,	1820,	24,	Manufacturer("Bombardier",	countryCode="CA"),	1768,	imageUrl ="https://www.norebbo.com/bombardier-global-7500-side-view/"),
    Model("Bombardier Global 5000",	"Bombardier Global",	20,	10,	26,	902,	9630,	19400000,	1820,	24,	Manufacturer("Bombardier",	countryCode="CA"),	1689,	imageUrl ="https://www.norebbo.com/bombardier-global-5000-blank-illustration-templates/"),
    ...
    Model("Cessna Caravan",	"Cessna",	15,	4,	14,	355,	2400,	4400000,	1820,	0,	Manufacturer("Cessna",	countryCode="US"),	762,	imageUrl ="https://www.norebbo.com/2017/06/cessna-208-grand-caravan-blank-illustration-templates/"),
    ...
    Model("Dassault Falcon 50",	"Dassault",	12,	8,	50,	903,	5660,	5400000,	1456,	24,	Manufacturer("Dassault",	countryCode="FR"),	1524,	imageUrl ="https://www.norebbo.com/dassault-falcon-50/"),
    Model("Douglas DC-3",	"DC-3",	32,	0,	121,	333,	2400,	2800000,	2080,	0,	Manufacturer("Douglas Aircraft Company",	countryCode="US"),	1312,	imageUrl =""),
    ...
    Model("Boeing 717-200",	"DC-9",	134,	5,	576,	811,	2645,	60700000,	1820,	36,	Manufacturer("Boeing",	countryCode="US"),	2100,	imageUrl ="https://www.norebbo.com/2017/06/boeing-717-200-blank-illustration-templates/"),
    ...
    Model("De Havilland Canada DHC-6-400",	"De Havilland Canada DHC-8",	19,	4,	22,	337,	1480,	6200000,	1820,	12,	Manufacturer("De Havilland Canada",	countryCode="CA"),	366,	imageUrl =""),
    ...
    Model("Embraer EMB120 Brasilia",	"EMB 120",	30,	4,	52,	552,	1750,	9400000,	1560,	0,	Manufacturer("Embraer",	countryCode="BR"),	1220,	imageUrl ="https://www.norebbo.com/2015/02/embraer-120-brasilia-blank-illustration-templates/"),
    ...
    Model("Lockheed Constellation L-749",	"Lockheed Constellation",	81,	1,	385,	555,	8039,	14800000,	1820,	12,	Manufacturer("Lockheed",	countryCode="US"),	1050,	imageUrl =""),
    ...
    Model("Mitsubishi MRJ-90",	"Mitsubishi SpaceJet",	92,	7,	211,	900,	3770,	94200000,	2080,	24,	Manufacturer("Mitsubishi",	countryCode="JP"),	1740,	imageUrl =""),
    Model("Mitsubishi MRJ-100",	"Mitsubishi SpaceJet",	88,	7,	202,	900,	3540,	86300000,	2080,	18,	Manufacturer("Mitsubishi",	countryCode="JP"),	1760,	imageUrl =""),
    Model("Pilatus PC-12",	"Pilatus",	9,	5,	10,	528,	3417,	2400000,	1456,	0,	Manufacturer("Pilatus",	countryCode="CH"),	758,	imageUrl =""),
    Model("Saab 2000",	"Saab Regional",	58,	5,	120,	608,	2868,	28900000,	1820,	12,	Manufacturer("Saab",	countryCode="SE"),	1252,	imageUrl =""),
    ...
    Model("Sukhoi KR860",	"Sukhoi",	860,	4,	5150,	1000,	15000,	403200000,	1300,	96,	Manufacturer("JSC Sukhoi",	countryCode="RU"),	3400,	imageUrl =""),
