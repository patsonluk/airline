...
object FlightType extends Enumeration {
    ...
    val SHORT_HAUL_DOMESTIC, LONG_HAUL_DOMESTIC, SHORT_HAUL_INTERNATIONAL, LONG_HAUL_INTERNATIONAL, SHORT_HAUL_INTERCONTINENTAL, MEDIUM_HAUL_INTERCONTINENTAL, LONG_HAUL_INTERCONTINENTAL, ULTRA_LONG_HAUL_INTERCONTINENTAL = Value

    val getCategory = (flightType : FlightType.Value) => flightType match {
        case SHORT_HAUL_DOMESTIC | LONG_HAUL_DOMESTIC => FlightCategory.DOMESTIC
        case SHORT_HAUL_INTERNATIONAL | LONG_HAUL_INTERNATIONAL => FlightCategory.INTERNATIONAL
