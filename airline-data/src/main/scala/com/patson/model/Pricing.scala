...
object Pricing {
  ...
  def computeStandardPrice(distance : Int, flightType : FlightType, linkClass : LinkClass) : Int = {
    ...
    price = ((flightType match {
      case ULTRA_SHORT_HAUL_INTERNATIONAL | SHORT_HAUL_INTERNATIONAL | MEDIUM_HAUL_INTERNATIONAL | LONG_HAUL_INTERNATIONAL => (price * INTERNATIONAL_PRICE_MULTIPLIER)
      case ULTRA_SHORT_HAUL_INTERCONTINENTAL | SHORT_HAUL_INTERCONTINENTAL | MEDIUM_HAUL_INTERCONTINENTAL | LONG_HAUL_INTERCONTINENTAL | ULTRA_LONG_HAUL_INTERCONTINENTAL => (price * INTERCONTINENTAL_PRICE_MULTIPLIER)
      case _ => price
