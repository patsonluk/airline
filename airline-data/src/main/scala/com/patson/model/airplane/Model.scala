...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, countryCode = "US"),
                    ...
                    Model("Let L-410UVP-E20", "Let L-410", capacity = 19, fuelBurn = (19 * 1.9).toInt, speed = 417, range = 1356, price = 4200000, lifespan = 25 * 52, constructionTime = 0, countryCode = "RU", imageUrl = ""),
                      ...
                      Model("Mitsubishi MRJ-100", "Mitsubishi SpaceJet", capacity = 88, fuelBurn = (88 * 2.5).toInt, speed = 870, range = 3540, price = 60000000, lifespan = 35 * 52, constructionTime = 6, countryCode = "JP", imageUrl = ""),
                      ...
                      Model("Mitsubishi MRJ-90", "Mitsubishi SpaceJet", capacity = 92, fuelBurn = (92 * 2.5).toInt, speed = 870, range = 3770, price = 75000000, lifespan = 35 * 52, constructionTime = 8, countryCode = "JP", imageUrl = ""),
                      ...
                      Model("Bombardier CS300", "Bombardier CS", capacity = 160, fuelBurn = (160 * 3.5).toInt, speed = 828, range = 6112, price = 9800000, lifespan = 35 * 52, constructionTime = 20, countryCode = "CA", imageUrl = "https://www.norebbo.com/2016/02/bombardier-cs300-blank-illustration-templates/"),
                      ...
                      Model("Boeing 737-900", "Boeing 737 Next Generation", capacity = 189, fuelBurn = (189 * 3.8).toInt, speed = 830, range = 6660, price = 105000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "US", imageUrl = "https://www.norebbo.com/2014/08/boeing-737-900-blank-illustration-templates/"),
                      ...
                      Model("Boeing 737 MAX 9", "Boeing 737 MAX", capacity = 220, fuelBurn = (220 * 4).toInt, speed = 839, range = 6570, price = 124000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2018/05/boeing-737-9-max-blank-illustration-templates/"),
                      Model("Boeing 737 MAX 10", "Boeing 737 MAX", capacity = 230, fuelBurn = (230 * 4).toInt, speed = 830, range = 6500, price = 134000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2019/01/737-10-max-side-view/"),
