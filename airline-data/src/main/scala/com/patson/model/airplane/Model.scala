...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 708),
    ...
    Model("ATR 42-600S", "ATR-Regional", capacity = 48, fuelBurn = (48 * 1.6).toInt, speed = 556, range = 1308, price = 20000000, lifespan = 20 * 52, constructionTime = 0, Manufacturer("ATR", countryCode = "FR"), runwayRequirement = 750, imageUrl= ""),
    ...
    Model("de Havilland Canada DHC-7-100", "Bombardier DHC-8", capacity = 50, fuelBurn = (50 * 1.7).toInt, speed = 428, range = 1280, price = 32000000 , lifespan = 35 * 52, constructionTime = 0, Manufacturer("Bombardier", countryCode = "CA"), runwayRequirement = 689, imageUrl = ""),
    ...
    Model("Xian MA60", "Xian MA", capacity = 62, fuelBurn = (62 * 2.7).toInt, speed = 430, range = 1600, price = 20000000, lifespan = 25 * 52, constructionTime = 4, Manufacturer("Comac", countryCode = "CN"), runwayRequirement = 640, imageUrl = ""),
