...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 708),
    ...
    Model("Irkut MC-21-300", "Irkut", capacity = 211, fuelBurn = (211 * 4.2).toInt, speed = 870, range = 6000, price = 80_000_000, lifespan = 30 * 52, constructionTime = 24, Manufacturer("Irkut", countryCode = "RU"), runwayRequirement = 3000, imageUrl = "https://www.norebbo.com/irkut-mc-21-300/"),
