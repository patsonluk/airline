...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, countryCode = "US"),
                    Model("Pilatus PC-12", "Pilatus", capacity = 9, fuelBurn = (9 * 1.2).toInt, speed = 528, range = 3417, price = 4000000, lifespan = 35 * 52, constructionTime = 0, countryCode = "CH"),
                      ...
                      Model("Embraer EMB120 Brasilia", "Embraer EMB", capacity = 30, fuelBurn = (30 * 1.9).toInt, speed = 552, range = 1750, price = 8000000, lifespan = 35 * 52, constructionTime = 0, countryCode = "BR", imageUrl = "https://www.norebbo.com/2015/02/embraer-120-brasilia-blank-illustration-templates/"),
                      ...
                      Model("Embraer EMB170-200", "Embraer EMB", capacity = 88, fuelBurn = (88 * 3).toInt, speed = 871, range = 2200, price = 50000000, lifespan = 30 * 52, constructionTime = 4, countryCode = "BR", imageUrl = "https://www.norebbo.com/2015/10/embraer-erj-175-templates-with-the-new-style-winglets/"),
                      ...
                      Model("Embraer EMB190", "Embraer EMB", capacity = 100, fuelBurn = (100 * 3.3).toInt, speed = 823, range = 4537, price = 60000000, lifespan = 30 * 52, constructionTime = 8, countryCode = "BR", imageUrl = "https://www.norebbo.com/2015/06/embraer-190-blank-illustration-templates/"),
                      ...
                      Model("Boeing 737-700C", "Boeing 737", capacity = 140, fuelBurn = (140 * 3.3).toInt, speed = 825, range = 6083, price = 85000000, lifespan = 35 * 52, constructionTime = 12, countryCode = "US", imageUrl = "https://www.norebbo.com/2014/04/boeing-737-700-blank-illustration-templates/"),
                      ...
                      Model("McDonnel Douglas MD-90", "McDonnel Douglas MD-90", capacity = 160, fuelBurn = (160 * 3.55).toInt, speed = 811, range = 3787, price = 80000000, lifespan = 30 * 52, constructionTime = 18, countryCode = "US", imageUrl = "https://www.norebbo.com/2018/02/mcdonnell-douglas-md-90-blank-illustration-templates/"),
                      ...
                      Model("Boeing 737-800", "Boeing 737", capacity = 184, fuelBurn = (184 * 3.8).toInt, speed = 825, range = 5436, price = 100000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "US", imageUrl = "https://www.norebbo.com/2012/11/boeing-737-800-blank-illustration-templates/"),
                      ...
                      Model("Boeing 737 MAX 9", "Boeing 737", capacity = 230, fuelBurn = (230 * 4.2).toInt, speed = 839, range = 6570, price = 124000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2018/05/boeing-737-9-max-blank-illustration-templates/"),
                      ...
                      Model("McDonnel Douglas MD-11", "McDonnel Douglas MD-11", capacity = 293, fuelBurn = (293 * 4.9).toInt, speed = 876, range = 12670, price = 105000000, lifespan = 30 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2018/05/mcdonnell-douglas-md-11-blank-illustration-templates-with-ge-engines/"),
