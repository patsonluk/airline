...
object AllianceRole extends Enumeration {
  ...
  val LEADER, PRESIDENT, FOUNDING_MEMBER, MEMBER, APPLICANT = Value
}
...
object AllianceEvent extends Enumeration {
  ...
  val FOUND_ALLIANCE, APPLY_ALLIANCE, JOIN_ALLIANCE, REJECT_ALLIANCE, LEAVE_ALLIANCE, BOOT_ALLIANCE, BECAME_LEADER, BECAME_PRESIDENT = Value
}
