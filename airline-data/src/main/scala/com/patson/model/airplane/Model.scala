...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, countryCode = "US"),
                    ...
                    Model("Let L-410UVP-E20", "Let L-410", capacity = 19, fuelBurn = (19 * 1.9).toInt, speed = 417, range = 1356, price = 4200000, lifespan = 25 * 52, constructionTime = 0, countryCode = "RU", imageUrl = ""),
                      ...
                      Model("Bombardier CS300", "Bombardier CS", capacity = 160, fuelBurn = (160 * 3.3).toInt, speed = 828, range = 6112, price = 9800000, lifespan = 35 * 52, constructionTime = 20, countryCode = "CA", imageUrl = "https://www.norebbo.com/2016/02/bombardier-cs300-blank-illustration-templates/"),
                      Model("Boeing 737 MAX 7", "Boeing 737 MAX", capacity = 172, fuelBurn = (172 * 3.3).toInt, speed = 830, range = 6500, price = 105000000, lifespan = 35 * 52, constructionTime = 20, countryCode = "US", imageUrl = "https://www.norebbo.com/2016/07/boeing-737-max-7-blank-illustration-templates/"),
                      ...
                      Model("Boeing 737 MAX 8", "Boeing 737 MAX", capacity = 189, fuelBurn = (189 * 3.4).toInt, speed = 830, range = 6500, price = 120000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "US", imageUrl = "https://www.norebbo.com/2016/07/boeing-737-max-8-blank-illustration-templates/"),
