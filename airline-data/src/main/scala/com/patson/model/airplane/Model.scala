...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 708),
    ...
    Model("de Havilland Canada DHC-7-100", "Bombardier DHC-8", capacity = 50, fuelBurn = (50 * 1.5).toInt, speed = 428, range = 1280, price = 3900000 , lifespan = 35 * 52, constructionTime = 0, Manufacturer("Bombardier", countryCode = "CA"), runwayRequirement = 689, imageUrl = ""),
