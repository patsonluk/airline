...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 708),
    ...
    Model("Dornier 328-110", "Dornier 328", capacity = 33, fuelBurn = (33 * 1.8).toInt, speed = 620, range = 1310, price = 20000000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Dornier", countryCode = "DE"), runwayRequirement = 1088, imageUrl = "https://www.norebbo.com/2019/01/dornier-328-110-blank-illustration-templates/"),
    ...
    Model("ATR 42-600", "ATR-Regional", capacity = 48, fuelBurn = (48 * 1.5).toInt, speed = 556, range = 1326, price = 20000000, lifespan = 20 * 52, constructionTime = 0, Manufacturer("ATR", countryCode = "FR"), runwayRequirement = 1050, imageUrl = "https://www.norebbo.com/2018/06/atr-42-blank-illustration-templates/"),
    Model("Bombardier CRJ100", "Bombardier CRJ", capacity = 50, fuelBurn = (50 * 1.8).toInt, speed = 830, range = 2250, price = 25000000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Bombardier", countryCode = "CA"), runwayRequirement = 1920, imageUrl = "https://www.norebbo.com/2015/04/bombardier-canadair-regional-jet-200-blank-illustration-templates/"),
    Model("Bombardier CRJ200", "Bombardier CRJ", capacity = 50, fuelBurn = (50 * 1.8).toInt, speed = 830, range = 3150, price = 30000000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Bombardier", countryCode = "CA"), runwayRequirement = 1920, imageUrl = "https://www.norebbo.com/2015/04/bombardier-canadair-regional-jet-200-blank-illustration-templates/"),
    ...
    Model("Bombardier DHC-8-300", "Bombardier DHC-8", capacity = 56, fuelBurn = (56 * 2.2).toInt, speed = 450, range = 1711, price = 27000000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Bombardier", countryCode = "CA"), runwayRequirement = 1085, imageUrl = "https://www.norebbo.com/2018/05/de-havilland-dhc-8-300-blank-illustration-templates/"),
    Model("Saab 2000", "Saab Regional", capacity = 58, fuelBurn = (58 * 2.5).toInt, speed = 594, range = 2868, price = 25500000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Saab", countryCode = "SE"), runwayRequirement = 1252, imageUrl = ""),
    Model("Fokker 50", "Fokker", capacity = 60, fuelBurn = (60 * 2.6).toInt, speed = 471, range = 2400, price = 25000000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Fokker", countryCode = "NL"), runwayRequirement = 1350, imageUrl = ""),
    ...
    Model("ATR 72-600", "ATR-Regional", capacity = 78, fuelBurn = (78 * 2.8).toInt, speed = 556, range = 1528, price = 26000000, lifespan = 20 * 52, constructionTime = 4, Manufacturer("ATR", countryCode = "FR"), runwayRequirement = 1367, imageUrl = "https://www.norebbo.com/2017/04/atr-72-blank-illustration-templates/"),
    Model("Embraer ERJ175", "Embraer ERJ", capacity = 78, fuelBurn = (78 * 3.2).toInt, speed = 870, range = 4074, price = 35000000, lifespan = 30 * 52, constructionTime = 4, Manufacturer("Embraer", countryCode = "BR"), runwayRequirement = 2244),
    ...
    Model("Bombardier DHC-8-400", "Bombardier DHC-8", capacity = 86, fuelBurn = (86 * 2.7).toInt, speed = 667, range = 2063, price = 40000000, lifespan = 35 * 52, constructionTime = 6, Manufacturer("Bombardier", countryCode = "CA"), runwayRequirement = 1220, imageUrl = "https://www.norebbo.com/2015/08/bombardier-dhc-8-402-q400-blank-illustration-templates/"),
    ...
    Model("Bombardier Q400", "Bombardier DHC-8", capacity = 90, fuelBurn = (90 * 2.8).toInt, speed = 556, range = 2040, price = 35000000, lifespan = 30 * 52, constructionTime = 8, Manufacturer("Bombardier", countryCode = "CA"), runwayRequirement = 1885, imageUrl = "https://www.norebbo.com/2015/08/bombardier-dhc-8-402-q400-blank-illustration-templates/"),
    ...
    Model("Concorde", "Concorde", capacity = 128, fuelBurn = (128 * 14).toInt, speed = 2158, range = 7223, price = 220000000, lifespan = 30 * 52, constructionTime = 8, Manufacturer("BAe", countryCode = "GB"), runwayRequirement = 3600),
    Model("Airbus A318", "Airbus A320", capacity = 132, fuelBurn = (132 * 3.3).toInt, speed = 829, range = 7800, price = 90000000, lifespan = 35 * 52, constructionTime = 8, Manufacturer("Airbus", countryCode = "NL"), runwayRequirement = 1780),
    ...
    Model("Airbus A319", "Airbus A320", capacity = 156, fuelBurn = (156 * 3.4).toInt, speed = 830, range = 6940, price = 95000000, lifespan = 35 * 52, constructionTime = 16, Manufacturer("Airbus Douglas", countryCode = "NL"), runwayRequirement = 1850, imageUrl = "https://www.norebbo.com/2014/05/airbus-a319-blank-illustration-templates/"),
    ...
    Model("Boeing 757-200", "Boeing 757", capacity = 200, fuelBurn = (200 * 4.3).toInt, speed = 854, range = 7250, price = 95000000, lifespan = 35 * 52, constructionTime = 24, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2070, imageUrl = "https://www.norebbo.com/2015/01/boeing-757-200-blank-illustration-templates/"),
    ...
    Model("Airbus A310-200", "Airbus A300/A310", capacity = 240, fuelBurn = (240 * 4.4).toInt, speed = 850, range = 6800, price = 125000000, lifespan = 35 * 52, constructionTime = 36, Manufacturer("Airbus", countryCode = "NL"), runwayRequirement = 1860, imageUrl = "https://www.norebbo.com/2018/11/airbus-a300b4-600r-blank-illustration-templates-with-general-electric-engines/"),
