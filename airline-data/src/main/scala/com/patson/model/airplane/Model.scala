...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 708),
    ...
    Model("Cessna Citation X", "Cessna", capacity = 12, fuelBurn = (12 * 1.5).toInt, speed = 850, range = 5053, price = 5000000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 1600, imageUrl = "https://www.norebbo.com/cessna-citation-x-template/"),
    ...
    Model("Gulfstream G650ER", "Gulfstream", capacity = 19, fuelBurn = (19 * 1.5).toInt, speed = 904, range = 13890, price = 30000000, lifespan = 40 * 52, constructionTime = 0, Manufacturer("Gulfstream", countryCode = "US"), runwayRequirement = 1920, imageUrl = "https://www.norebbo.com/gulfstream-g650er-template/"),
