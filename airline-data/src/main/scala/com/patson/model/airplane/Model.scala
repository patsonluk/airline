...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 708),
    ...
    Model("Ilyushin Il-62", "Ilyushin Il-62", capacity = 186, fuelBurn = (186 * 4.8).toInt, speed = 900, range = 10000, price = 60_000_000, lifespan = 25 * 52, constructionTime = 32, Manufacturer("Ilyushin", countryCode = "RU"), runwayRequirement = 2300),
