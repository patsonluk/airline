...
case object FIRST extends LinkClass("F", spaceMultiplier = 8, resourceMultiplier = 4, priceMultiplier = 15, 3)
case object BUSINESS extends LinkClass("J", spaceMultiplier = 2, resourceMultiplier = 2, priceMultiplier = 4, 2)
