...
val models = List(Model("Airbus A300-600", capacity = 266, fuelBurn = (266 * 4.5).toInt, speed = 833, range = 7500, price = 110000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "EU", series = Series("Airbus A300/310-Family")),		
			...
			´	  Model("Airbus A330-200", capacity = 404, fuelBurn = (404 * 4.5).toInt, speed = 870, range = 13400, price = 235000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "EU", series = Series("Airbus A330-Family")),	
				  ...
				  Model("Let L-410UVP-E20", capacity = 19, fuelBurn = (19 * 1.2).toInt, speed = 417, range = 1356, price = 5000000, lifespan = 25 * 52, constructionTime = 0, countryCode = "RU", series = Series("Let L-410-Family")),
		  		  Model("McDonnel Douglas MD-81", capacity = 150, fuelBurn = (150 * 3.3).toInt, speed = 811, range = 3787, price = 75000000, lifespan = 30 * 52, constructionTime = 18, countryCode = "US", series = Series("McDonnell-Douglas MD-Family")),
		  		  Model("McDonnel Douglas MD-90", capacity = 160, fuelBurn = (160 * 3.3).toInt, speed = 811, range = 3787, price = 80000000, lifespan = 30 * 52, constructionTime = 18, countryCode = "US", series = Series("McDonnell-Douglas MD-Family")),
		  		  Model("McDonnel Douglas MD-11", capacity = 293, fuelBurn = (293 * 4.9).toInt, speed = 876, range = 12670, price = 105000000, lifespan = 30 * 52, constructionTime = 36, countryCode = "US", series = Series("McDonnell-Douglas MD-Family")),
