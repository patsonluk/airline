...
object Model {
  ...
  val models = List(Model("Cessna 421", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, countryCode = "US"),
                    Model("Pilatus PC-12", capacity = 9, fuelBurn = (9 * 1.2).toInt, speed = 528, range = 3417, price = 4000000, lifespan = 35 * 52, constructionTime = 0, countryCode = "CH"),
                      ...
                      Model("Irkut MC-21-200", capacity = 165, fuelBurn = (165*3.4).toInt, speed = 870, range = 6400, price = 72000000, lifespan = 30 * 52, constructionTime = 24, countryCode = "RU"),
                      Model("Tupolev Tu-154", capacity = 180, fuelBurn = (180*5).toInt, speed = 950, range = 5280, price = 45000000, lifespan = 25 * 52, constructionTime = 24, countryCode = "RU", imageUrl = "https://www.norebbo.com/2019/05/tupolev-tu-154-side-view/"),
                      ...
                      Model("Irkut MC-21-300", capacity = 211, fuelBurn = (211*4.1).toInt, speed = 870, range = 6000, price = 91000000, lifespan = 30 * 52, constructionTime = 32, countryCode = "RU"),
