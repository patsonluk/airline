...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, countryCode = "US"),
                    ...
                    Model("Let L-410UVP-E20", "Let L-410", capacity = 19, fuelBurn = (19 * 1.9).toInt, speed = 417, range = 1356, price = 4200000, lifespan = 25 * 52, constructionTime = 0, countryCode = "RU", imageUrl = ""),
                      ...
                      Model("Bombardier CRJ900", "Bombardier CRJ", capacity = 90, fuelBurn = (90 * 2.9).toInt, speed = 885, range = 2876, price = 45000000, lifespan = 35 * 52, constructionTime = 12, countryCode = "CA", imageUrl = "https://www.norebbo.com/2016/07/bombardier-canadair-regional-jet-900-blank-illustration-templates/"),
                      Model("Mitsubishi MRJ-90", "Mitsubishi SpaceJet", capacity = 92, fuelBurn = (92 * 2.5).toInt, speed = 417, range = 3770, price = 75000000, lifespan = 35 * 52, constructionTime = 6, countryCode = "JP", imageUrl = ""),
                      ...
                      Model("Bombardier CRJ1000", "Bombardier CRJ", capacity = 104, fuelBurn = (104 * 3).toInt, speed = 870, range = 3004, price = 50000000, lifespan = 35 * 52, constructionTime = 12, countryCode = "CZ", imageUrl = "https://www.norebbo.com/2019/06/bombardier-crj-1000-side-view/"),
                      Model("Embraer E190-E2", "Embraer E-Jet E2", capacity = 106, fuelBurn = (106 * 3.5).toInt, speed = 870, range = 5278, price = 45000000, lifespan = 35 * 52, constructionTime = 0, countryCode = "BR", imageUrl = "https://www.norebbo.com/2019/03/e190-e2-blank-side-view/"),
                      ...
                      Model("Boeing 737-100", "Boeign 737 Original", capacity = 124, fuelBurn = (124 * 4).toInt, speed = 780, range = 3440, price = 40000000, lifespan = 35 * 52, constructionTime = 12, countryCode = "US", imageUrl = "https://www.norebbo.com/2018/10/boeing-737-100-blank-illustration-templates/"),
                      ...
                      Model("Boeing 737-600", "Boeing 737 Next Generation", capacity = 149, fuelBurn = (149 * 3.9).toInt, speed = 830, range = 7200, price = 82500000, lifespan = 35 * 52, constructionTime = 18, countryCode = "US", imageUrl = "https://www.norebbo.com/2018/09/boeing-737-600-blank-illustration-templates/"),
                      Model("Boeing 737-700", "Boeing 737 Next Generation", capacity = 149, fuelBurn = (149 * 3.8).toInt, speed = 830, range = 7630, price = 85000000, lifespan = 35 * 52, constructionTime = 18, countryCode = "US", imageUrl = "https://www.norebbo.com/2014/04/boeing-737-700-blank-illustration-templates/"),
                      ...
                      Model("McDonnel Douglas MD-81", "McDonnel Douglas", capacity = 150, fuelBurn = (150 * 3.5).toInt, speed = 811, range = 3787, price = 75000000, lifespan = 30 * 52, constructionTime = 18, countryCode = "US",imageUrl = "https://www.norebbo.com/2015/02/mcdonnell-douglas-md-80-blank-illustration-templates/"),
                      ...
                      Model("Airbus A320", "Airbus A320", capacity = 180, fuelBurn = (180 * 3.6).toInt, speed = 828, range = 6150, price = 100000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "EU", imageUrl = "https://www.norebbo.com/2013/08/airbus-a320-blank-illustration-templates/"),
                      ...
                      Model("Airbus A321neoXLR", "Airbus A320", capacity = 236, fuelBurn = (236 * 4.4).toInt, speed = 828, range = 8700, price = 130000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "EU", imageUrl = "https://www.norebbo.com/2018/10/airbus-a321neo-lr-long-range-blank-illustration-templates/"),
                      Model("Boeing 757-200ER", "Airbus 757", capacity = 239, fuelBurn = (239 * 4.3).toInt, speed = 850, range = 9170, price = 135000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2015/01/boeing-757-200-blank-illustration-templates/"),
                      Model("Airbus A310-200", "Airbus A300/310", capacity = 240, fuelBurn = (240 * 4.4).toInt, speed = 850, range = 6800, price = 125000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "EU", imageUrl = "https://www.norebbo.com/2018/11/airbus-a300b4-600r-blank-illustration-templates-with-general-electric-engines/"),
                      Model("Airbus A310-300", "Airbus A300/310", capacity = 240, fuelBurn = (240 * 4.3).toInt, speed = 850, range = 8050, price = 130000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "EU", imageUrl = "https://www.norebbo.com/2015/07/airbus-a310-300-blank-illustration-templates/"),
                      Model("Airbus A321neoLR", "Airbus A320", capacity = 240, fuelBurn = (240 * 3.8).toInt, speed = 828, range = 7400, price = 132000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "EU", imageUrl = "https://www.norebbo.com/2018/10/airbus-a321neo-lr-long-range-blank-illustration-templates/"),
                      Model("Airbus A321neo", "Airbus A320", capacity = 244, fuelBurn = (244 * 3.7).toInt, speed = 828, range = 6850, price = 130000000, lifespan = 35 * 52, constructionTime = 18, countryCode = "EU", imageUrl = "https://www.norebbo.com/2017/09/airbus-a321-neo-blank-illustration-templates/"),
                      ...
                      Model("Airbus A300-600", "Airbus A300", capacity = 266, fuelBurn = (266 * 4.4).toInt, speed = 833, range = 7500, price = 110000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "NL", imageUrl = "https://www.norebbo.com/2018/11/airbus-a300b4-600r-blank-illustration-templates-with-general-electric-engines/"),
                      ...
                      Model("Boeing 747SP", "Boeing 747", capacity = 400, fuelBurn = (400 * 5).toInt, speed = 1000, range = 15400, price = 180000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "US", imageUrl = "https://www.norebbo.com/2019/08/boeing-747sp-side-view/"),
                      Model("Airbus A330-200", "Airbus 330", capacity = 404, fuelBurn = (404 * 4.7).toInt, speed = 870, range = 13400, price = 235000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "EU", imageUrl = "https://www.norebbo.com/2016/02/airbus-a330-200-blank-illustration-templates-with-pratt-whitney-engines/"),
                      Model("Airbus A330-800neo", "Airbus 330", capacity = 406, fuelBurn = (406 * 4.5).toInt, speed = 912, range = 13900, price = 260000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "EU", imageUrl = "https://www.norebbo.com/2018/06/airbus-a330-800-neo-blank-illustration-templates/"),
                      ...
                      Model("Airbus A350-900", "Airbus A350", capacity = 440, fuelBurn = (440 * 4.9).toInt, speed = 903, range = 15000, price = 280000000, lifespan = 35 * 52, constructionTime = 48, countryCode = "NL", imageUrl = "https://www.norebbo.com/2013/07/airbus-a350-900-blank-illustration-templates/"),
                      Model("Airbus A330-900neo", "Airbus 330", capacity = 440, fuelBurn = (440 * 4.5).toInt, speed = 912, range = 12130, price = 290000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "EU", imageUrl = "https://www.norebbo.com/2018/06/airbus-a330-900-neo-blank-illustration-templates/"),
                      Model("Airbus A340-600", "Airbus 340", capacity = 440, fuelBurn = (440 * 5.2).toInt, speed = 905, range = 13900, price = 290000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "EU", imageUrl = "https://www.norebbo.com/2016/11/airbus-a340-600-blank-illustration-templates/"),
                      Model("Airbus A350-900ULR", "Airbus A350", capacity = 440, fuelBurn = (440 * 5.2).toInt, speed = 910, range = 17960, price = 325000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "EU", imageUrl = "https://www.norebbo.com/2013/07/airbus-a350-900-blank-illustration-templates/"),
                      ...
                      Model("Airbus A350-1000", "Airbus A350", capacity = 475, fuelBurn = (475 * 4.5).toInt, speed = 910, range = 15550, price = 360000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "EU", imageUrl = "https://www.norebbo.com/2015/11/airbus-a350-1000-blank-illustration-templates/"),
                      Model("Boeing 747-100", "Boeing 747", capacity = 550, fuelBurn = (550 * 5.7).toInt, speed = 895, range = 9800, price = 250000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2019/07/boeing-747-100-side-view/"),
                      Model("Boeing 747-200", "Boeing 747", capacity = 550, fuelBurn = (550 * 5.7).toInt, speed = 895, range = 12700, price = 260000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2019/08/boeing-747-200-side-view/"),
                      Model("Boeing 777-300", "Boeing 777", capacity = 550, fuelBurn = (550 * 5.6).toInt, speed = 945, range = 11121, price = 300000000, lifespan = 35 * 52, constructionTime = 48, countryCode = "US", imageUrl = "https://www.norebbo.com/2014/03/boeing-777-300-blank-illustration-templates/"),
                      Model("Boeing 777-300ER", "Boeing 777", capacity = 550, fuelBurn = (550 * 5.7).toInt, speed = 896, range = 13649, price = 340000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2014/03/boeing-777-300-blank-illustration-templates/"),
                      Model("Boeing 777-9", "Boeing 777", capacity = 550, fuelBurn = (550 * 4.9).toInt, speed = 896, range = 13940, price = 450000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2019/12/boeing-777-9-side-view/"),
                      Model("Boeing 747-8i", "Boeing 747", capacity = 605, fuelBurn = (605 * 5.2).toInt, speed = 920, range = 14815, price = 420000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2015/12/boeing-747-8i-blank-illustration-templates/"),
                      Model("Boeing 747-300", "Boeing 747", capacity = 660, fuelBurn = (660 * 6.2).toInt, speed = 910, range = 12400, price = 290000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2019/10/boeing-747-300-side-view/"),
                      ...
                      Model("Boeing 747-400ER", "Boeing 747", capacity = 660, fuelBurn = (660 * 6.2).toInt, speed = 913, range = 14200, price = 350000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "US", imageUrl = "https://www.norebbo.com/2013/09/boeing-747-400-blank-illustration-templates/"),
