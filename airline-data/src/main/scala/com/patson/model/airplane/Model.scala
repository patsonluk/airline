...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, countryCode = "US"),
                    ...
                    Model("Let L-410UVP-E20", "Let L-410", capacity = 19, fuelBurn = (19 * 1.9).toInt, speed = 417, range = 1356, price = 4200000, lifespan = 25 * 52, constructionTime = 0, countryCode = "RU", imageUrl = ""),
                      ...
                      Model("Boeing 737-100", "Boeing 737 Original", capacity = 124, fuelBurn = (124 * 4).toInt, speed = 780, range = 3440, price = 40000000, lifespan = 35 * 52, constructionTime = 12, countryCode = "US", imageUrl = "https://www.norebbo.com/2018/10/boeing-737-100-blank-illustration-templates/"),
                      ...
                      Model("Airbus A310-200", "Airbus A300/A310", capacity = 240, fuelBurn = (240 * 4.4).toInt, speed = 850, range = 6800, price = 125000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "EU", imageUrl = "https://www.norebbo.com/2018/11/airbus-a300b4-600r-blank-illustration-templates-with-general-electric-engines/"),
                      Model("Airbus A310-300", "Airbus A300/A310", capacity = 240, fuelBurn = (240 * 4.3).toInt, speed = 850, range = 8050, price = 130000000, lifespan = 35 * 52, constructionTime = 24, countryCode = "EU", imageUrl = "https://www.norebbo.com/2015/07/airbus-a310-300-blank-illustration-templates/"),
                      ...
                      Model("Airbus A350-800", "Airbus A350", capacity = 390, fuelBurn = (390 * 3.8).toInt, speed = 910, range = 15860, price = 280000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "EU", imageUrl = "https://www.norebbo.com/2015/06/airbus-a350-800-blank-illustration-templates/"),
                      ...
                      Model("Airbus A330-200", "Airbus A330", capacity = 404, fuelBurn = (404 * 4.7).toInt, speed = 870, range = 13400, price = 235000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "EU", imageUrl = "https://www.norebbo.com/2016/02/airbus-a330-200-blank-illustration-templates-with-pratt-whitney-engines/"),
                      Model("Airbus A330-800neo", "Airbus A330", capacity = 406, fuelBurn = (406 * 4.5).toInt, speed = 912, range = 13900, price = 260000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "EU", imageUrl = "https://www.norebbo.com/2018/06/airbus-a330-800-neo-blank-illustration-templates/"),
                      ...
                      Model("Airbus A330-900neo", "Airbus A330", capacity = 440, fuelBurn = (440 * 4.5).toInt, speed = 912, range = 12130, price = 290000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "EU", imageUrl = "https://www.norebbo.com/2018/06/airbus-a330-900-neo-blank-illustration-templates/"),
                      Model("Airbus A340-600", "Airbus A340", capacity = 440, fuelBurn = (440 * 5.2).toInt, speed = 905, range = 13900, price = 290000000, lifespan = 35 * 52, constructionTime = 36, countryCode = "EU", imageUrl = "https://www.norebbo.com/2016/11/airbus-a340-600-blank-illustration-templates/"),
