...
object Model {
  ...
  val models = List(Model("Cessna 421", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, countryCode = "US"),
                      ...
                      Model("Antonov An148", capacity = 85, fuelBurn = (85 * 3.5).toInt, speed = 835, range = 3500, price = 30000000, lifespan = 20 * 52, constructionTime = 4, countryCode = "UA"),
                      Model("Embrarer EMB 170-200", capacity = 88, fuelBurn = (88 * 2.8).toInt, speed = 871, range = 2200, price = 50000000, lifespan = 30 * 52, constructionTime = 4, countryCode = "BR"),
                      ...
                      Model("Sukhoi Superjet 100", capacity = 108, fuelBurn = (108 * 3.2).toInt, speed = 828, range = 4578, price = 40000000, lifespan = 30 * 52, constructionTime = 8, countryCode = "RU"),
                      Model("Airbus A318", capacity = 132, fuelBurn = (132 * 3).toInt, speed = 829, range = 7800, price = 85000000, lifespan = 35 * 52, constructionTime = 8, countryCode = "NL"),
                      Model("Bombardier CS100", capacity = 133, fuelBurn = (133 * 3.5).toInt, speed = 828, range = 5741, price = 38000000, lifespan = 35 * 52, constructionTime = 8, countryCode = "CA"),
                      Model("Boeing 737-700C", capacity = 140, fuelBurn = (140 * 3.5).toInt, speed = 825, range = 6083, price = 73000000, lifespan = 35 * 52, constructionTime = 12, countryCode = "US"),
                      ...
                      Model("Ilyushin 96-400", capacity = 436, fuelBurn = (436 * 6).toInt, speed = 870, range = 10000, price = 50000000, lifespan = 30 * 52, constructionTime = 36, countryCode = "RU"),
