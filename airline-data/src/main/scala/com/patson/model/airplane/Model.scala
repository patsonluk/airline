...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, countryCode = "US"),
                    ...
                    Model("Let L-410UVP-E20", "Let L-410", capacity = 19, fuelBurn = (19 * 1.9).toInt, speed = 417, range = 1356, price = 4200000, lifespan = 25 * 52, constructionTime = 0, countryCode = "RU", imageUrl = ""),
                      ...
                      Model("Bombardier CRJ100", "Bombardier CRJ", capacity = 50, fuelBurn = (50 * 1.6).toInt, speed = 830, range = 2250, price = 25000000, lifespan = 35 * 52, constructionTime = 0, countryCode = "CA", imageUrl = "https://www.norebbo.com/2015/04/bombardier-canadair-regional-jet-200-blank-illustration-templates/"),
                      ...
                      Model("Mitsubishi MRJ-100", "Mitsubishi SpaceJet", capacity = 88, fuelBurn = (88 * 2.1).toInt, speed = 900, range = 3540, price = 68000000, lifespan = 40 * 52, constructionTime = 6, countryCode = "JP", imageUrl = ""),
                      ...
                      Model("Mitsubishi MRJ-90", "Mitsubishi SpaceJet", capacity = 92, fuelBurn = (92 * 2.1).toInt, speed = 900, range = 3770, price = 75000000, lifespan = 40 * 52, constructionTime = 8, countryCode = "JP", imageUrl = ""),
