...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 708),
    ...
    Model("Dassault Falcon 50", "Dassault Falcon", capacity = 9, fuelBurn = (9 * 1.6).toInt, speed = 800, range = 5660, price = 2_373_750, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Dassault", countryCode = "FR"), runwayRequirement = 1524, imageUrl = "https://www.norebbo.com/dassault-falcon-50/"),
    ...
    Model("Bombardier Global 5000", "Bombardier Global", capacity = 13, fuelBurn = (13 * 1.5).toInt, speed = 902, range = 9630, price = 10_000_000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Bombardier", countryCode = "CA"), runwayRequirement = 1689, imageUrl = "https://www.norebbo.com/bombardier-global-5000-blank-illustration-templates/"),
    ...
    Model("Bombardier Global 7500", "Bombardier Global", capacity = 19, fuelBurn = (19 * 1.6).toInt, speed = 902, range = 14260, price = 20_000_000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Bombardier", countryCode = "CA"), runwayRequirement = 1768, imageUrl = "https://www.norebbo.com/bombardier-global-7500-side-view/"),
    ...
    Model("McDonnell Douglas DC-8-50", "McDonnell Douglas MD", capacity = 189, fuelBurn = (189 * 4.3).toInt, speed = 895, range = 10843, price = 100_000_000, lifespan = 30 * 52, constructionTime = 24, Manufacturer("McDonnell Douglas", countryCode = "US"), runwayRequirement = 3000, imageUrl = "https://www.norebbo.com/douglas-dc-8-53-blank-illustration-templates/"),
    ...
    Model("Irkut MC-21-300", "Irkut", capacity = 211, fuelBurn = (211 * 4.2).toInt, speed = 870, range = 6000, price = 80_000_000, lifespan = 30 * 52, constructionTime = 24, Manufacturer("Irkut", countryCode = "RU"), runwayRequirement = 30000, imageUrl = "https://www.norebbo.com/irkut-mc-21-300/"),
