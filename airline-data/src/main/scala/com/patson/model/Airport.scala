...
object BonusType extends Enumeration {
  ...
  val NATIONAL_AIRLINE, PARTNERED_AIRLINE, OLYMPICS_VOTE, OLYMPICS_PASSENGER, SANTA_CLAUS, CAMPAIGN, NEGOTIATION_BONUS, BASE_SPECIALIZATION_BONUS, HOME_BASE_LOYALTY, BANNER, NO_BONUS = Value
  val description : BonusType.Value => String = {
    ...
    case HOME_BASE_LOYALTY => "Home Base Loyalty Bonus"
