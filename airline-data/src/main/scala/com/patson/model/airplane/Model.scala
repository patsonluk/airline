...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 708),
    ...
    Model("Ilyushin Il-114-300", "Ilyushin Il-114", capacity = 68, fuelBurn = (68 * 3.3).toInt, speed = 470, range = 1000, price = 19_500_000, lifespan = 25 * 52, constructionTime = 8, Manufacturer("Ilyushin", countryCode = "RU"), runwayRequirement = 1600),
    ...
    Model("Ilyushin Il-18", "Ilyushin Il-18", capacity = 120, fuelBurn = (120 * 4.2).toInt, speed = 625, range = 6500, price = 33_000_000, lifespan = 25 * 52, constructionTime = 8, Manufacturer("Ilyushin", countryCode = "RU"), runwayRequirement = 1350),
    ...
    Model("Sukhoi Superjet 130NG", "Sukhoi Superjet", capacity = 145, fuelBurn = (145 * 4.6).toInt, speed = 871, range = 4008, price = 48_000_000, lifespan = 30 * 52, constructionTime = 12, Manufacturer("JSC Sukhoi", countryCode = "RU"), runwayRequirement = 1900),
    ...
    Model("Ilyushin Il-62", "Ilyushin Il-62", capacity = 186, fuelBurn = (186 * 4.8).toInt, speed = 900, range = 10000, price = 60_000_000, lifespan = 25 * 52, constructionTime = 32 * 52, Manufacturer("Ilyushin", countryCode = "RU"), runwayRequirement = 2300),
    ...
    Model("Ilyushin Il-86", "Ilyushin Il-96", capacity = 320, fuelBurn = (320 * 5.5).toInt, speed = 831, range = 5000, price = 90_000_000, lifespan = 25 * 52, constructionTime = 36, Manufacturer("Ilyushin", countryCode = "RU"), runwayRequirement = 2800),
